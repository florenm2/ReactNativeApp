...
class ApiContainer extends Component {
    ...
    componentDidMount() {
        ...
        axios.post(
            ...
            setTimeout(() => {
                this.setState({
                    loading: false,
                    merchantLocatorData: response.data
                })
            }, 2000)
        })
    ...
    render() {
        ...
        return (
            ...
            merchantLocatorData={this.state.merchantLocatorData}
